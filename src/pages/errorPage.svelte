...
<body class="bg-purple">
    ...
    <div class="stars">
        ...
        <div class="central-body">
           ...
           <h4 class="btn-go-home" >Click on Earth to go Back Home</h4>
        </div>
        <div class="objects">
            <img class="object_rocket" src="http://salehriaz.com/404Page/img/rocket.svg" width="40px">
            <div class="earth-moon">
                <button class="object_earth" on:click={navigateHome}>
                    <img  src="http://salehriaz.com/404Page/img/earth.svg" width="100px" >
                </button>
